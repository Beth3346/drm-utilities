patterns =
    numberBegins: new RegExp "^(?:\\-?\\d+|\\d*)(?:\\.?\\d+|\\d)"
    alphaBegins: new RegExp '^[a-z ,.\\-]*','i'
    # mm/dd/yyyy
    monthDayYearBegins: new RegExp '^(?:[0]?[1-9]|[1][012]|[1-9])[-\/.](?:[0]?[1-9]|[12][0-9]|[3][01])(?:[-\/.][0-9]{4})'
    # 00:00pm
    timeBegins: new RegExp '^(?:[12][012]|[0]?[0-9]):[012345][0-9](?:am|pm)', 'i'
